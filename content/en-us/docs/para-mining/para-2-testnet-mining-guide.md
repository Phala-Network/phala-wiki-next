...
- Para-2 [Polkadot.js UI](https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Fpara2-api.phala.network%2Fws#/explorer)
...
- [1 Check Your Hardware, BIOS and System]({{< relref "docs/mine-solo/1-0-hardware-requirements" >}})
- [1.2 Install Phala Tools]({{< relref "docs/mine-solo/1-2-download-setup-scripts" >}})
- [1.3 Check the SGX Capability and Confidence Level]({{< relref "1-2-confidential-level-evaluation" >}})
- [1.4 Benchmarking]({{< relref "docs/mine-solo/1-4-benchmarking" >}})

### II. Deploying Khala Network

- [2 Solo mining]({{< relref "docs/mine-solo/2-0-solo-mining" >}})
- [2.1 Deploy Worker Node]({{< relref "docs/mine-solo/2-1-deploy-worker-node" >}})
- [2.2 Verify Worker Status]({{< relref "docs/mine-solo/2-2-verify-worker-status" >}})
- [2.3 Upgrade Worker Node]({{< relref "docs/mine-solo/2-3-upgrade-worker-node" >}})
- [2.4 Use Console to Manage Your Mining]({{< relref "docs/mine-solo/3-0-console" >}})

### III. FAQ

- [Frequently Asked Questions]({{< relref "docs/mine-solo/4-0-faq" >}})
