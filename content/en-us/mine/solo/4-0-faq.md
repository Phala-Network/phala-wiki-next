...
If you still have issues attempt to [update the script](/en-us/maintain/mine-solo/2-3-upgrade-worker-node/).
...
You may now [restart your node](/en-us/maintain/mine-solo/4-0-faq/#general).
...
If the Khala Chain stops synching and is stuck at a specific block and does not continue to sync, we advise you first to [restart your node](/en-us/maintain/mine-solo/4-0-faq/#general).
...
You can follow [this tutorial](/en-us/maintain/mine-solo/1-1-installing-phala-mining-tools/) to redownload and reinstall the new phala mining scripts.
